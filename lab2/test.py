...
# my test 
def test_seam_pattern():
    im = lab.load_color_image('test_images/pattern.png')
    ...
    # compare_greyscale_images(grey, expect_grey)
    ...
    # compare_greyscale_images(energy, expect_energy)
    ...
    # compare_greyscale_images(cem, expect_cem) # fixed

    expect_seam = [2, 11, 21, 31]
    assert sorted(seam) == expect_seam
